...
import fr.ekito.example.web.filter.CachingHttpHeadersFilter;
import fr.ekito.example.web.filter.StaticResourcesProductionFilter;
import fr.ekito.example.web.filter.gzip.GZipServletFilter;
