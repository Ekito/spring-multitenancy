package fr.ekito.example.config.oauth2;

import fr.ekito.example.domain.OAuth2AuthenticationAccessToken;
import fr.ekito.example.domain.OAuth2AuthenticationRefreshToken;
