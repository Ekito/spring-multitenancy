 ...
 */
public class DomainAwareMongoTemplate extends MongoTemplate {

    private final Logger log = LoggerFactory.getLogger(getClass());

    public DomainAwareMongoTemplate(MongoDbFactory mongoDbFactory, MappingMongoConverter mappingMongoConverter) {
    ...
    private void injectGroupCriteria(Query query) {
